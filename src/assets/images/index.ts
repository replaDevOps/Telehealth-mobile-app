...
export const LogoDarkPng = require("./LOGOPNG_DARK.png");
export const authBgLight = require("./auth_bg_light.png");
export const authBgDark = require("./auth_bg_dark.png");
export const SplashBottomIcon = require("./splashBottomIcon.png");
export const SplashIcon = require("./splashIcon.png");
